...
This document outlines the requirements for implementing dark mode in the Ayatsuri UI. The implementation will provide a modern, developer-friendly dark theme as the default, with the ability to switch to light mode. The solution leverages existing CSS variable infrastructure and Tailwind CSS dark mode capabilities.
...
- Enhance the professional appearance of the Ayatsuri workflow orchestration engine
...
### 4.2 Storage
- **TR-5**: Theme preference SHALL be stored with key 'ayatsuri-theme'
