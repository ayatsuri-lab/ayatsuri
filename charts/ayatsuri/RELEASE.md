...
This GitHub release publishes the packaged `ayatsuri` Helm chart for the Helm repository at `https://ayatsuri-lab.github.io/ayatsuri`. It is not a Ayatsuri application binary release.
