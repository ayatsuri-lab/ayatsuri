...
const PLATFORM_MAP = {
  ...
  "linux-x64": "ayatsuri-linux-x64",
  "linux-arm64": "ayatsuri-linux-arm64",
  "darwin-x64": "ayatsuri-darwin-x64",
  "darwin-arm64": "ayatsuri-darwin-arm64",
  "win32-x64": "ayatsuri-win32-x64",

  // Tier 2 - Common but less frequent
  "linux-ia32": "ayatsuri-linux-ia32",
  "win32-ia32": "ayatsuri-win32-ia32",
  "freebsd-x64": "ayatsuri-freebsd-x64",

  // Tier 3 - Rare platforms
  "win32-arm64": "ayatsuri-win32-arm64",
  "linux-ppc64": "ayatsuri-linux-ppc64",
  "linux-s390x": "ayatsuri-linux-s390x",
  "freebsd-arm64": "ayatsuri-freebsd-arm64",
  "freebsd-ia32": "ayatsuri-freebsd-ia32",
  "freebsd-arm": "ayatsuri-freebsd-arm",
  "openbsd-x64": "ayatsuri-openbsd-x64",
  "openbsd-arm64": "ayatsuri-openbsd-arm64",
};
...
function getPlatformPackage() {
  ...
  if (platform === "linux" && arch === "arm") {
    ...
    return `ayatsuri-linux-armv${variant}`;
  }
...
/**
 * Get the path to the Ayatsuri binary
...
function getBinaryPath() {
  ...
  const binaryName = process.platform === "win32" ? "ayatsuri.exe" : "ayatsuri";
